...
This styleguide covers the two page types found in `docs/src/content/docs/`: **Overview pages** and **standard pages**. Every category (agents, memory, workflows, etc.) has one overview page and one or more standard pages.
