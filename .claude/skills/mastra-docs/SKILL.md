...
- `@docs/src/content/` - This subfolder contains the actual markdown files for the documentation site, organized into `docs/`, `guides/`, and `reference/` sections. The `models/` subfolder contains auto-generated documentation for model providers and should not be edited manually.
...
- `@docs/styleguides/DOC.md` - For any file inside `@docs/src/content/docs/`
- For any file inside `@docs/src/content/guides/` choose the correct styleguide based on content:
...
- `@docs/styleguides/REFERENCE.md` - For any file inside `@docs/src/content/reference/`
